...
\begin{figure}
    \centering
    \input{passe-livre/graficos/cycle}
...
\begin{figure}[!ht]
    \begin{subfigure}[t]{0.45\linewidth}
      \input{passe-livre/graficos/static1}
      \caption{Oferta e demanda de votos}
      \label{fig_static1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.45\linewidth}
      \input{passe-livre/graficos/static2}
...
% \input{graficos/static1}
% \end{minipage}
% \hspace{0.1\linewidth}   
% \begin{minipage}{0.3\linewidth}
% \input{graficos/static2}
% \end{minipage}
...
\begin{figure}[!ht]
    ...
    \hfill
    \begin{subfigure}[t]{0.45\linewidth}
      \input{passe-livre/graficos/static4}
...
\input{passe-livre/tabelas/descritiva}
...
A descrição mais detalhada das variáveis adotadas se encontra no \ref{apendice_vars}.
...
\input{passe-livre/tabelas/event_study}
...
\label{apendice_vars}
\subsection{Regressão principal}
\subsubsection*{Abstenção}
\subsubsection*{Competitividade}
