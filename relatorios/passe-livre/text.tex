%Comentar basedosdados, , tone down 
...
\begin{figure}
    ...
    \input{relatorios/passe-livre/graficos/cycle}
    \label{cycle}
\end{figure}
...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.45\linewidth}
      \input{relatorios/passe-livre/graficos/static1}
      \caption{Oferta e demanda de votos}
      \label{fig_static1}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.45\linewidth}
      \input{relatorios/passe-livre/graficos/static2}
...
\begin{figure}[!ht]
  \caption{Estática comparativa e \textit{moral hazard}}
    ...
    \hfill
    \begin{subfigure}[t]{0.45\linewidth}
      \input{relatorios/passe-livre/graficos/static4}
...
\input{relatorios/passe-livre/tabelas/descritiva}
...
\input{relatorios/passe-livre/tabelas/event_study}
...
\input{relatorios/passe-livre/tabelas/variaveis-psm.tex}

\input{relatorios/passe-livre/tabelas/variaveis-dd.tex}